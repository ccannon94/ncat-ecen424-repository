...
entity three_eight_decoder_low_selected_tb is
end;

architecture tb_behavioral of three_eight_decoder_low_selected_tb is
	component three_eight_decoder_low_selected is
...
begin
	uut : three_eight_decoder_low_selected port map(tb_input, tb_output);
